...
__export(app_exports, {
  PasswordRecoveryPublisher: () => PasswordRecoveryPublisher,
  app: () => app
});
...
__decorateClass([
  ...
  (0, import_class_validator7.Length)(5, 20)
...
var user_routes_default = (router2) => {
  router2.get("/user/:username", makeFindByUsernameController());
  router2.get(
    "/users/:page",
...
var PasswordRecoveryPublisher = new Producer(
  "RECOVERY_PASSWORD",
  amqp
);
var startup = async () => {
